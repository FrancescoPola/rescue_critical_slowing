...
print(doc, target = "ox_model_summary.docx")
```
...
doc <- read_docx()
doc <- body_add_flextable(doc, value = ft)
print(doc, target = "Ox_table_output.docx")
...
doc <- read_docx()
doc <- body_add_flextable(doc, value = ft)
print(doc, target = "chla_model_summary.docx")
```
...
doc <- read_docx()
doc <- body_add_flextable(doc, value = ft)
print(doc, target = "Chla_table_output.docx")
...
doc <- read_docx()
doc <- body_add_flextable(doc, value = ft)
print(doc, target = "PEROMANOVA_table_output.docx")
